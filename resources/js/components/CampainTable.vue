      ...
      <table id="campains" class="table table-bordered border-primary  text-center" style="width:100%">
          ...
          <tbody>
              <tr v-for="camp in campains" :key="camp.id">
                  ...
                  <td class="">
                    <a href="#" class="py-px px-1 text-2xs rounded-1 no-underline" style="background-color: #fb5597; color: #fff;">Pestañas de Estados</a>
                    <a href="#" class="py-px px-1 text-2xs rounded-1 no-underline" style="background-color: #ff5b57; color: #fff;">Estados</a>
                    <a href="#" class="py-px px-1 text-2xs rounded-1 no-underline" style="background-color: #90ca4b; color: #fff;">Bloques de Campos</a>
                    <a href="#" class="py-px px-1 text-2xs rounded-1 no-underline" style="background-color: #32a932; color: #fff;">Campos</a>
